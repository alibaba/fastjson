...
public class WriteClassNameTest_Set extends TestCase {
    ...
    public void test_list() throws Exception {
        ...
        Assert.assertEquals("{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set$A\",\"list\":[{},{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set$B1\"}]}",
                            text);
