...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public FieldInfo(String name, //
        ...
        this.serialzeFeatures = serializeFeatures;
        ...
        if (field != null) {
            ...
            fieldAccess = true; // 'method = null' is true
    ...
    public FieldInfo(String name, //
                     ...
                     String label){
        this(name, method, field, clazz, type, ordinal, serializeFeatures, parserFeatures,
    ...
    public int compareTo(FieldInfo o) {
        ...
        boolean isSameType = this.field != null && this.field.getType() == this.fieldClass;
        boolean oSameType = o.field != null && o.field.getType() == o.fieldClass;

        if (isSameType && !oSameType) {
            return 1;
        }

        if (oSameType && !isSameType) {
            return -1;
        }
