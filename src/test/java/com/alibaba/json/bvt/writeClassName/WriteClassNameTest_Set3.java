...
public class WriteClassNameTest_Set3 extends TestCase {
    ...
    public void test_list() throws Exception {
        ...
        Assert.assertEquals("{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set3$A\",\"list\":[{},{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set3$B1\"}]}",
                            text);
