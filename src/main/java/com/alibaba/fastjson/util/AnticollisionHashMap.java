 ...
 * <tt>SafelyHashMap</tt> instance (the number of buckets) plus its size (the number
 * of key-value mappings).  Thus, it's very important not to set the initial
 * capacity too high (or the load factor too low) if iteration performance is
 * important.
 *
 * <p>An instance of <tt>SafelyHashMap</tt> has two parameters that affect its
 ...
 *
 * <p>If many mappings are to be stored in a <tt>SafelyHashMap</tt> instance,
 ...
 *   Map m = Collections.synchronizedMap(new SafelyHashMap(...));</pre>
 *
    ...
    implements Map<K,V>, Cloneable, Serializable
{
     ...
     * the SafelyHashMap fail-fast.  (See ConcurrentModificationException).
     */
    ...
    /**
     * Constructs an empty <tt>SafelyHashMap</tt> with the default initial capacity
     ...
     * after SafelyHashMap has been initialized but before any entries have
     ...
     * because SafelyHashMap uses power-of-two length hash tables, that
     ...
     * SafelyHashMap.  Returns null if the SafelyHashMap contains no mapping
     * for the key.
     */
     ...
     * in the SafelyHashMap.  Returns null if the SafelyHashMap contains no mapping
     * for this key.
     */
    ...
    /**
     * Returns a shallow copy of this <tt>SafelyHashMap</tt> instance: the keys and
