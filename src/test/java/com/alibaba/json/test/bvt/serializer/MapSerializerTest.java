...
public class MapSerializerTest extends TestCase {
    ...
    public void test_empty_1() throws Exception {
        ...
        mapSerializer.write(new JSONSerializer(out), Collections.EMPTY_MAP, null);
    ...
    public void test_singleton_1() throws Exception {
        ...
        MapSerializer mapSerializer = new MapSerializer();
        mapSerializer.write(new JSONSerializer(out), Collections.singletonMap("A", 1), null);
    ...
    public void test_int2_s() throws Exception {
        ...
        map.put("A", 1);
        map.put("B", 2);
        mapSerializer.write(new JSONSerializer(out), map, null);
    ...
    public void test_string3_s() throws Exception {
        ...
        map.put("A", "1");
        map.put("B", "2");
        mapSerializer.write(serializer, map, null);
