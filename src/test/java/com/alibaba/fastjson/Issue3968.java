...
public class Issue3968 {
    ...
    public void reproduce() {
        final String str1 = "{\"rank\": 2.4444444E7}";
        final String str2 = "{\"rank\": 2.4E7}";
        JSONObject jo1 = JSON.parseObject(str1);
        JSONObject jo2 = JSON.parseObject(str2);
        Assert.assertEquals("reproduce the issue", "{\"rank\":24444444}", JSON.toJSONString(jo1));
        Assert.assertEquals("reproduce the issue", "{\"rank\":2.4E+7}", JSON.toJSONString(jo2));
    }
