...
public class WriteDuplicateType extends TestCase {
    ...
    public void test_dupType() throws Exception {
        ...
        Assert.assertEquals("{\"@type\":\"java.util.LinkedHashMap\",\"1001\":{\"@type\":\"com.alibaba.fastjson.JSONObject\",\"@type\":\"com.alibaba.json.bvt.writeClassName.WriteDuplicateType$DianDianCart\",\"id\":1001}}", text1);
