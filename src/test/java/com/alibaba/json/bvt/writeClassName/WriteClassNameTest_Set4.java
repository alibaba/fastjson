...
public class WriteClassNameTest_Set4 extends TestCase {
    ...
    public void test_list() throws Exception {
        ...
        Assert.assertEquals("{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set4$A\",\"list\":[{},{\"@type\":\"com.alibaba.json.test.bvt.writeClassName.WriteClassNameTest_Set4$B1\"}]}",
                            text);
