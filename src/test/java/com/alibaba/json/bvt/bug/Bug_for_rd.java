...
public class Bug_for_rd extends TestCase {
    public void test_for_issue() throws Exception {
        ...
        assertEquals("{\"saveAsset\":\"false\",\"acquirementId\":\"20190718194010800100177150204979354\",\"orderTerminalType\":\"WEB\",\"acqSiteUserId\":\"2177220032166157\",\"siteReqBizId\":\"111023437\",\"msisdn\":\"01966114400\",\"originalMerchantOrderId\":\"602109378031994\"}", extendInfo);
    }

    public void test_for_issue_1() throws Exception {
        String json = "{ \"sitePayId\": \"2019071889031100000152604119889\", \"unit\" : \"MINUTES\"}";
