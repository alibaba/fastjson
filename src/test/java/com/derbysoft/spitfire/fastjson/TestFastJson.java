...
public class TestFastJson {
    ...
    public void test() throws Exception {
        ...
        String text = JSON.toJSONString(createTest(), SerializerFeature.WriteClassName, SerializerFeature.PrettyFormat);
    ...
    public void f_testFP() throws IOException {
        Generic<String> q = new Generic<String>();
...
//        SerializeWriter out = new SerializeWriter();
    ...
    public void f_testSerializePerformance() throws IOException {
        Object obj = createExpectedHotelAvailRS();
    ...
    public void f_testDeserializePerformance() throws IOException, ClassNotFoundException {
        Object obj = createExpectedHotelAvailRS();
        ...
        for (int x = 0; x < 20; ++x) {
            ...
            for (int i = 0; i < TIMES; ++i) {
//                ByteArrayInputStream is = new ByteArrayInputStream(bytes);
                Object o = jsonDeserialize(bytes, HotelAvailRS.class);
                o.getClass();
            }
            stopWatch.stop();
