...
//    }
    ...
    public static <T> T cast(final Object obj, final Class<T> clazz, ParserConfig config) {
        ...
        T retObj = (T) ModuleUtil.callWhenHasJavaSql(new Callable<Object>() {
            public Object call() {
    ...
    private static Callable<Void> addBaseClassMappingsFunction = new Callable<Void>() {
        public Void call() {
    ...
    private static void addBaseClassMappings() {
        ...
        ModuleUtil.callWhenHasJavaSql(addBaseClassMappingsFunction);
    }
